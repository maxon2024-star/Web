...
* [Лекция 11. POST, Axios. Диаграммы бизнес требований](lectures/Lecture_12_Axios.pdf)

* [Лекция 12. Адаптивная верстка. PWA. Tauri](lectures/Lecture_11_PWA.pdf)
...
* Добавление ассистента с помощью `WebLLM` для `гостя` на строне браузера (Chrome, Яндекс, Arc) в приложение React для консультаций пользователя по описанию услуг на странице `Списка услуг`. [Методические указания WebLLM](/tutorials/WebLLM/README.md) 
